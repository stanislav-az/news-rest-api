...
module News.Database.Models.News where
...
import News.Database.Models.Author (Author(..))
import News.Database.Models.Category (CategoryNested(..))
import News.Database.Models.Tag (Tag(..))
...
import News.Database.Queries.Tag (getTagsByNewsId)
