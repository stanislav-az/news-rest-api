...
module News.Database.Models.Author where
...
import News.Database.Queries.Queries (inductiveTupleToTuple)
import News.WebServer.Database (Fit(..), Limit(..), Offset(..), Persistent(..))
